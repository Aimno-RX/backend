        ...
        for (file_name, source_type) in zip(filename_list, source_types_list):
            ...
            if source_type == 'local file':
                if gcs_file_cache:
                    ...
                    logging.info(f'Keep local source file when deleting graph data: {merged_file_path}')
            else:
                logging.info(f'Non-local source delete requested for file: {file_name}, source_type: {source_type}')

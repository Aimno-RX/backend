...
class Schema(BaseModel):
    ...
    triplets: List[str] = Field(default=[], description="list of node labels and relationship types in a graph schema in <NodeType1>-<RELATIONSHIP_TYPE>-><NodeType2> format")
